...
@section('title', 'Edit Sell Application - Promoter Share Management')
@section('page-title', 'Edit Sell Application')
    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-header">
                <h5 class="mb-0">Edit Sell Application</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('sell-applications.update', $application->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('seller_id') is-invalid @enderror" id="seller_id" name="seller_id" required>
                            ...
                            @foreach($shareholders as $shareholder)
                                <option value="{{ $shareholder->id }}" {{ old('seller_id', $application->seller_id) == $shareholder->id ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('share_quantity_to_sell') is-invalid @enderror" 
                                   id="share_quantity_to_sell" name="share_quantity_to_sell" value="{{ old('share_quantity_to_sell', $application->share_quantity_to_sell) }}" min="1" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('proposed_price_per_share') is-invalid @enderror" 
                                   id="proposed_price_per_share" name="proposed_price_per_share" value="{{ old('proposed_price_per_share', $application->proposed_price_per_share) }}" 
                                   step="0.01" min="0">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('application_date') is-invalid @enderror" 
                               id="application_date" name="application_date" value="{{ old('application_date', $application->application_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('reason') is-invalid @enderror" 
                                  id="reason" name="reason" rows="3">{{ old('reason', $application->reason) }}</textarea>
                        @error('reason')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('sell-applications.show', $application->id) }}" class="btn btn-secondary">
