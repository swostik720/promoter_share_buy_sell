        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('sell-applications.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="demat_account" class="form-label">Demat Account Details <span class="text-danger">*</span></label>
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <small class="text-muted">
                        ...
                        All documents must be uploaded during application submission.
                    </small>
                </div>
            </div>
        </div>
